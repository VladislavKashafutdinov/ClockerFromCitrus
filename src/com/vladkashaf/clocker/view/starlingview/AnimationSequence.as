package com.vladkashaf.clocker.view.starlingview {
	...
	public class AnimationSequence extends Sprite {
		...
		public static function fromMovieClip(
			ce:StarlingCitrusEngine,
			swf:flash.display.MovieClip,
			firstAnim:String = null, 
			animFps:int = 30, 
			firstAnimLoop:Boolean = true, 
			smoothing:String = "bilinear"):AnimationSequence
		{
			var textureAtlas:TextureAtlas = DynamicAtlas.fromMovieClipContainer(
				swf, ce.scaleFactor, 0, true, true);
